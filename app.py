...
def addNewMember():
    ...
    if (memExist):
        ...
        if (memExistData):
            ...
            return render_template('newGroup.html', displayAddMember = displayAddMember, dispGroupName = groupName, error=error)
        else:
            ...
            return render_template('newGroup.html',displayAddMember=displayAddMember,dispGroupName=groupName, message = message)
